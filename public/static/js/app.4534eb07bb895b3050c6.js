...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_32d0011e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_userCallChat_vue__ = __webpack_require__(1355);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_32d0011e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_userCallChat_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      tongjiApi.getUserChatNum({
        ...
        _this.myChart = _this.$echarts.init(document.getElementById('myChart'));
        if (_this.demos == 0) {
          var dx = ['0次', '1次', '2~4次', '5~10次', '11~20次', '21~50次', '50+次'];
          var option = ['呼通次数'];
          var series = {
            name: '呼通次数',
            type: 'bar',
...
//# sourceMappingURL=app.4534eb07bb895b3050c6.js.map